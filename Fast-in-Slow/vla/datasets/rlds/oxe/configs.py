...
class StateEncoding(IntEnum):
    ...
    UAV_POS_EULER = 6       # UAV XYZ (3) + Roll-Pitch-Yaw (3) without Gripper
    # fmt: on
...
class ActionEncoding(IntEnum):
    ...
    UAV_POS = 6             # UAV Delta XYZ (3) + Roll-Pitch-Yaw (3) without Gripper
    # fmt: on
...
OXE_DATASET_CONFIGS = {
    ...
    "rlbench": {
        "image_obs_keys": {"head_slow": "image_head_slow", "head_fast": "image_head_fast"},
        "depth_obs_keys": {"primary": None, "secondary": None, "wrist": None},
        "state_obs_keys": ["base_pose_tool_reached", "gripper_closed"],
        "state_encoding": StateEncoding.POS_QUAT,
        "action_encoding": ActionEncoding.EEF_POS,
    ...
    "uav_dataset": {
        ...
        "state_encoding": StateEncoding.UAV_POS_EULER,
        "action_encoding": ActionEncoding.UAV_POS,
    },
}
